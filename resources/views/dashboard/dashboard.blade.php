                            ...
                            <div class="card-body">
                                <div class="presencecontent">
                                    ...
                                    <div class="presencedetail">
                                        ...
                                        <span><span>{{ $presensihariini != null ? $presensihariini->jam_in : 'Belum Absen' }}</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 14px 10px !Important ">
                                ...
                                <ion-icon name="walk-outline" style="font-size: 2rem;" class="text-primary "></ion-icon>
                                <br>
                                <span style="font-size: 0.6rem font-weight:500">Hadir</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 14px 10px !Important">
                                ...
                                <ion-icon name="newspaper-outline" style="font-size: 2rem;" class="text-success"></ion-icon>
                                <br>
                                <span style="font-size: 0.6rem font-weight:500">Izin</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 14px 10px !Important">
                                ...
                                <ion-icon name="bandage-outline" style="font-size: 2rem;" class="text-warning"></ion-icon>
                                <br>
                                <span style="font-size: 0.6rem font-weight:500">Sakit</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 14px 10px !Important">
                                ...
                                <ion-icon name="alarm-outline" style="font-size: 2rem;" class="text-danger"></ion-icon>
                                <br>
                                <span style="font-size: 0.6rem font-weight:500">Telat</span>
                            </div>
                        </div>
                    </div>
                </div>
