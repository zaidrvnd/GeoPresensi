...
class PresensiController extends Controller
{
    ...
    {
        //berfungsi untuk mengecek karyawan sudah absensi masuk atau belum
        $hariini = date("Y-m-d");
    ...
    {
        //berfungsi untuk menyimpan data absen masuk dan keluar
        $nik = Auth::guard('karyawan')->user()->nik;
        ...
        $file = $folderPath . $fileName;
            ...
            if($radius > $lok_kantor->radius){ //fungsi mengecek radius lokasi kantor
            ...
            if($cek > 0){
                ...
                if($update){
                    echo "success|Data Absensi Diterima, Hati Hati Dijalan!|out";
                    Storage::put($file, $image_base64);
                } else {
                    echo "error|Absensi Gagal, Hubungi Tim IT|out";
                }
            }else{
            $data = [
                'nik' => $nik,
            ...
            if($simpan){
                echo "success|Data Absensi Diterima, Selamat Bekerja!|in";
                Storage::put($file, $image_base64);
            } else {
                echo "error|Absensi Gagal, Hubungi Tim IT|in";
            }
        ...
        public function perizinan(Request $request){
            ...
            if(!empty($request->jenis_izin)){
                $query->where('status',$request->jenis_izin);
            }
